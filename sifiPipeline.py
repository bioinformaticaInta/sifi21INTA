...
import sifi21INTA.free_energy as free_energy
import sifi21INTA.general_helpers as general_helpers
...
class SifiPipeline(object):
    def __init__(self, bowtie_db, query_sequences, mode=0, sirna_size=21, mismatches=0, accessibility_check=True,
        ...
        self.rnaplfold_location = "/usr/local/bin"                                # Rnaplfold path
        ...
        self.no_efficience = True
        if self.accessibility_check and self.strand_check and self.end_check and self.terminal_check:
            self.no_efficience = False
            ...
            if main_targets == "Canceled":
                ...
                if input_data:
                    ...
                    if json_lst:
                        ...
                        #TODO: En el json file esta toda la informacion!!!!
                        ###################################
    ...
    def get_main_target(self):
        ...
        main_targets = sorted(all_targets.items(), key=lambda x: x[1], reverse=True)
        return main_targets
